...
public class ConfigScreen extends AbstractConfigScreen {
	...
	private GridWidget createPageOne() {
		...
		ButtonWidget shaders = ButtonWidget.builder(Translation.getConfigTranslation(Data.version.getID(), "shaders", new Formatting[]{Shaders.getRandomColor()}), (button) -> ClientData.minecraft.setScreen(new ShadersConfigScreen(getRefreshScreen(), false, new Formatting[]{Shaders.getRandomColor()}))).build();
